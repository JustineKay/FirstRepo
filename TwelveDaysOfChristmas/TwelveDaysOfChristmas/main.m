...
int main(int argc, const char * argv[]) {
    @autoreleasepool {
        //FIRST ATTEMPT with ARRAYS and STRINGS...
...
//                NSLog(@"%@ %@ %@ %@.", onThe, twelveDays[0], christmasLove, twelveGifts[0]);
        ...
        // SECOND ATTEMPT with ARRAYS...  I tried "arraysWithObjects" even though I didn't know what it would do. It didn't work.
...
//        NSLog(@"%@ %@ %@ %@.", repeatingVerse [0], twelveDays[0], repeatingVerse [1], twelveGifts[0]);
        ...
        //THIRD ATTEMPT with STRINGS only... If all else fails... Back to basics.  It works.
        ...
        //FOURTH ATTEMPT back at ARRAYS... After I took a peek at Christella's code I was able to fix up my original idea to work with arrays. It works!
